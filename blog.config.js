...
const BLOG = {
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/liaoloo', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-1845739055340742', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
